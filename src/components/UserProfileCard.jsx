...
const UserProfileCard = () => {
  ...
  return (
    <div className="min-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
      {/* Dropdown Button */}
      <div className="flex justify-end px-4 pt-4">
        ...
        {isOpen && (
          <div
            className="absolute mt-10 right-4 z-10 text-base list-none bg-white divide-y divide-gray-100 
